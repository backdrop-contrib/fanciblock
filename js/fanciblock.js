(function ($) {
  ...
  // Behavior to load fanciblock
  Backdrop.behaviors.fanciblock = {
    attach: function(context, settings) {
      $('.fanciblock', context).once('fanciblock', function() {
        $(this).each(function() {
          ...
          // $(this).find(".fanciblock-icon img").width(fa_icon_size);
          // $(this).find(".fanciblock-icon img").height(fa_icon_size);
          // $(this).find(".fanciblock-icon img").css('line-height', fa_icon_size+'px');
